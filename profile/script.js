...
function validateInputs(indNo){
    ...
    let conditions = [inputs[0].value.length>=1,inputs[1].value.length>=1,inputs[2].value.match(mailformat),inputs[3].value.match(passFormat),inputs[3].value===inputs[4].value]
    if(conditions[indNo]){
